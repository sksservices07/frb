...
const wss =
  environment === 'test' ? process.env.WSS_ETHER_TEST : process.env.WSS_ETHER_MAIN
console.log('[WSS]: ', wss)
...
async function get_token_creation_time(token_address) {
  ...
  const res = await axios.get(
    `https://api.etherscan.com/api?module=account&action=txlist&address=${token_address}&startblock=0&endblock=99999999&page=1&offset=10&sort=asc&apikey=IH25T1JC2I8S6AT4577MAU9VV2P7EE56NZ`
  )
